...
#     /* ==================== SIDEBAR TOGGLE FIX - ALWAYS VISIBLE ==================== */
    
#     /* Target both possible button identifiers */
...
#         box-shadow: 0 0 40px rgba(0,255,136,1) !important;
#     }

#     /* Ensure the sidebar itself has a dark background */
